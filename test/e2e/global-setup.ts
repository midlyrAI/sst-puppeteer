 ...
 *
 * Responsibilities:
 *   1. Build dist/ so the tests can spawn the real bins.
 *   2. Materialize `test/fixtures/fake-sst/node_modules/.bin/sst` — a POSIX
...
export default async function setup(): Promise<void> {
  ...
  for (const rel of ['dist/bin/cli.js', 'dist/bin/mcp.js']) {
