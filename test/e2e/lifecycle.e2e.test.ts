 ...
 *
 * Strategy: spawn the built bins (`dist/bin/cli.js`, `dist/bin/mcp.js`) as
...
const cliEntry = path.join(repoRoot, 'dist', 'bin', 'cli.js');
const mcpEntry = path.join(repoRoot, 'dist', 'bin', 'mcp.js');
const fixtureDir = path.join(repoRoot, 'test', 'fixtures', 'fake-sst');
