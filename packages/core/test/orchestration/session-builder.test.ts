...
import { SessionBuilder } from '../../src/orchestration/session-builder.js';
import { SSTSession } from '../../src/orchestration/session.js';
import { type PtyAdapter } from '../../src/api/pty-adapter.js';
import { FakeEventStream } from '../helpers/fake-event-stream.js';
import { type SstBusEvent } from '../../src/domain/sst-bus-event.js';

const noopAdapter: PtyAdapter = {
  pid: 1,
  async spawn() {},
  write() {},
  onData() {
