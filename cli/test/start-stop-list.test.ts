...
import { ListSessionsCommand } from '../src/commands/list-sessions-command.js';
import { readMeta, writeMeta } from '../../shared/src/session/meta.js';
import { allSessionDirs, sessionDir, socketPath } from '../../shared/src/session/paths.js';
import { type CliContext } from '../src/commands/command.js';
